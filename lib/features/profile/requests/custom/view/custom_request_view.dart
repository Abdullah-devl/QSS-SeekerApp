...
import '../viewmodel/custom_request_view_model.dart';
import 'package:geolocator/geolocator.dart';
import 'package:geocoding/geocoding.dart';
import 'package:seeker/features/beProvider/views/pick_location_view.dart';
import 'package:google_maps_flutter/google_maps_flutter.dart';

/// 📂 اسم الملف: custom_request_view.dart
/// 📝 الوصف: شاشة إرسال طلب مخصص لمقدم الخدمة.
class CustomRequestView extends StatelessWidget {
  const CustomRequestView({super.key});

  @override
  Widget build(BuildContext context) {
    final colors = context.qsColors;
    final vm = context.watch<CustomRequestViewModel>();
  ...
  Widget _buildHeader(dynamic colors) {
    return Column(
      ...
      children: [
        ...
        Text(
          'سيقوم مقدم الخدمة بمراجعة تفاصيل طلبك وتحديد السعر المناسب لاحقاً.',
  ...
  Widget _buildMessageField(CustomRequestViewModel vm, dynamic colors) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text(
        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              hintText: 'اشرح ما تحتاجه بالتفصيل هنا...',
              hintStyle: TextStyle(color: colors.textSub.withOpacity(0.5)),
