...
class MeetingRequestView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('طلب حضور', style: TextStyle(fontWeight: FontWeight.bold)),
        centerTitle: true,
        leading: IconButton(
  ...
  Widget _buildLocationSection(BuildContext context, MeetingRequestViewModel vm, dynamic colors) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
        ...
        Text(
          ...
          style: TextStyle(fontSize: 12, color: colors.textSub.withOpacity(0.6)),
        ),
      ],
    );
  }

  Widget _buildSubmitButton(BuildContext context, MeetingRequestViewModel vm, dynamic colors) {
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        child: vm.isLoading
            ...
            : const Text('إرسال طلب الحضور', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
      ),
    );
  }

  void _handleSubmission(BuildContext context, MeetingRequestViewModel vm) async {
