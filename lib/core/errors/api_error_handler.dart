...
// /// 📝 الوصف: كلاس مسؤول عن تحويل الاستثناءات (Exceptions) إلى رسائل خطأ مفهومة (Failure).
...
//         // محاولة البحث عن رسالة خطأ داخل الرد
...
//           return response.data; // في حال كان الرد نصاً مباشراً
//         }
//       }
//       // رسائل افتراضية حسب الكود
